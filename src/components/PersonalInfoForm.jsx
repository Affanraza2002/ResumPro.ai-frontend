import { BriefcaseBusiness, Globe, Key, Linkedin, LinkedinIcon, Mail, MapPin, Phone, User } from 'lucide-react'
  ...
  return (
    <div>
        ...
        <div className='flex items-center gap-2'>
            <label>{data.image?( <img src={typeof data.image ==='string' ? data.image : URL.createObjectURL(data.image)} alt="user-image" className='w-16 h-16 rounded-full object-cover mt-5 ring  ring-slate-300 hover:opacity-80' />  ):(
            ...
            {typeof data.image ==='object' && ( <div className='flex flex-col gap-1 pl-4 text-sm'>
          ...
          {fields.map((field)=>{const Icon = field.icon; return(
