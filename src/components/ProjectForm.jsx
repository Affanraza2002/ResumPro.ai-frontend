    ...
    <Plus className='size-4'/> Add Project
                      ...
                      {data.map((project,index)=>(
                        ...
                        <div className='grid  gap-3'>
                           ...
                           <textarea value={project.description || ""} rows={4} onChange={(e)=> updateProject(index,"description",e.target.value)}   placeholder='Describe your project...' className='w-full px-3 py-2 text-sm rounded-lg resize-none' />
